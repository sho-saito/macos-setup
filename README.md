...
- **dockutil**, **mas**, **node**, **gh**, **claude**, **yamllint** - Dock management, Mac App Store CLI, Node.js, GitHub CLI, Claude CLI, and YAML linter
- **copilot-cli** - GitHub Copilot CLI (via Homebrew Cask)
